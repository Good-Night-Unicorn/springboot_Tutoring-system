...
public class XuexifankuiController {
    ...
    public R page(@RequestParam Map<String, Object> params,XuexifankuiEntity xuexifankui,
		...
		if(tableName.equals("jiajiao")) {
			xuexifankui.setJiajiaozhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("xuesheng")) {
			xuexifankui.setXuehao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("jiazhang")) {
			xuexifankui.setJiazhangzhanghao((String)request.getSession().getAttribute("username"));
		}
    ...
    public R add(@RequestBody XuexifankuiEntity xuexifankui, HttpServletRequest request){
    	//ValidatorUtils.validateEntity(xuexifankui);
    	xuexifankui.setUserid((Long)request.getSession().getAttribute("userId"));
        xuexifankuiService.insert(xuexifankui);
    ...
    public R update(@RequestBody XuexifankuiEntity xuexifankui, HttpServletRequest request){
        //ValidatorUtils.validateEntity(xuexifankui);
        xuexifankuiService.updateById(xuexifankui);//全部更新
        return R.ok();
    }
