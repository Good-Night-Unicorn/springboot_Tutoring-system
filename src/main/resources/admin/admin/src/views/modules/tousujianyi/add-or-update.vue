	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-else-if="ruleForm.tousushijian" label="投诉时间" prop="tousushijian" >
			...
			<el-form-item v-else-if="ruleForm.tousuneirong" label="投诉内容" prop="tousuneirong" >
				<span class="text" v-html="ruleForm.tousuneirong"></span>
			</el-form-item>
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.tousuneirong = this.ruleForm.tousuneirong.replace(reg,'../../../springboot484n4tm2/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
