		...
		>
			<template >
				<el-form-item class="input" v-if="type!='info'"  label="公告名称" prop="gonggaomingcheng" >
					<el-input v-model="ruleForm.gonggaomingcheng" placeholder="公告名称" clearable  :readonly="ro.gonggaomingcheng"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="公告名称" prop="gonggaomingcheng" >
					<el-input v-model="ruleForm.gonggaomingcheng" placeholder="公告名称" readonly></el-input>
				</el-form-item>
			...
			<el-form-item v-else-if="ruleForm.gonggaoneirong" label="公告内容" prop="gonggaoneirong" >
				<span class="text" v-html="ruleForm.gonggaoneirong"></span>
			</el-form-item>
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.gonggaoneirong = this.ruleForm.gonggaoneirong.replace(reg,'../../../springboot484n4tm2/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
