	...
	<div class="addEdit-block">
		...
		>
			...
			<el-form-item v-else-if="ruleForm.huodongxiangqing" label="活动详情" prop="huodongxiangqing" >
				<span class="text" v-html="ruleForm.huodongxiangqing"></span>
			</el-form-item>
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.huodongxiangqing = this.ruleForm.huodongxiangqing.replace(reg,'../../../springboot484n4tm2/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
