		...
		<template v-if="showFlag">
			...
			<div :style='{"border":"0px solid #fff","width":"100%","padding":"0 20px 20px","fontSize":"14px","color":"#000","background":"#fff"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' :sortable='true' prop="xuexishipin" label="学习视频">
						<template slot-scope="scope">
							<el-button v-if="scope.row.xuexishipin" type="text" size="small" @click="preClick(scope.row.xuexishipin)">预览</el-button>
							<span v-else >无</span>
						</template>
					</el-table-column>
					<el-table-column :resizable='true' :sortable='true' prop="jiaoxueziliao" label="教学资料">
						<template slot-scope="scope">
							<el-button v-if="scope.row.jiaoxueziliao" type="text" size="small" @click="download(scope.row.jiaoxueziliao)">下载</el-button>
							<span v-else >无</span>
						</template>
					</el-table-column>
					<el-table-column :resizable='true' :sortable='true'  
