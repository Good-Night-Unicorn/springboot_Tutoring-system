<template>
	<div class="center-preview">
		...
		<div class="center-info">
			...
			<div class="img-box" v-if="userTableName=='jiajiao'">
				<img :src="sessionForm.touxiang?baseUrl + sessionForm.touxiang:require('@/assets/avator.png')">
			</div>
			<div class="img-box" v-if="userTableName=='jiajiao'">
				<img :src="sessionForm.jiajiaozizhi?baseUrl + sessionForm.jiajiaozizhi:require('@/assets/avator.png')">
			</div>
		...
		<el-tabs class="center-tabs" tab-position="left" @tab-click="handleClick">
			<el-tab-pane label="个人中心">
				<el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="180px">
					...
					<el-form-item class="center-item" v-if="userTableName=='xuesheng'" label="手机号码" prop="shoujihaoma">
					...
					<el-form-item class="center-item" v-if="userTableName=='jiazhang'" label="联系电话" prop="lianxidianhua">
...
<script>
	...
	export default {
		...
		created() {
			...
			if ('jiazhang' == this.userTableName&&this.rules['jiazhangzhanghao']){
				this.rules['jiazhangzhanghao'].push({ required: true, message: '请输入家长账号', trigger: 'blur' })
			}else if('jiazhang' == this.userTableName&&!this.rules['jiazhangzhanghao']) {
				this.$set(this.rules, 'jiazhangzhanghao', [{ required: true, message: '请输入家长账号', trigger: 'blur' }]);
			}
			if ('jiazhang' == this.userTableName&&this.rules['mima']){
				this.rules['mima'].push({ required: true, message: '请输入密码', trigger: 'blur' })
			}else if('jiazhang' == this.userTableName&&!this.rules['mima']) {
				this.$set(this.rules, 'mima', [{ required: true, message: '请输入密码', trigger: 'blur' }]);
			}
			if ('jiazhang' == this.userTableName&&this.rules['jiazhangxingming']){
				this.rules['jiazhangxingming'].push({ required: true, message: '请输入家长姓名', trigger: 'blur' })
			}else if('jiazhang' == this.userTableName&&!this.rules['jiazhangxingming']) {
				this.$set(this.rules, 'jiazhangxingming', [{ required: true, message: '请输入家长姓名', trigger: 'blur' }]);
			}
			if ('jiazhang' == this.userTableName) {
