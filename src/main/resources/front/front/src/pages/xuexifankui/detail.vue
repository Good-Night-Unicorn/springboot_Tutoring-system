<template>
	...
	<!--  -->
		...
		<div class="detail-preview">
			<div class="attr">
				<div class="info">
					...
					<div class="item">
						...
						<div class="text "  >{{detail.xuexibeizhu}}</div>
					</div>
					<div class="item">
					...
					<div class="item">
						<div class="lable">教学资料</div>
						<el-button class="uploadBtn" @click="download(detail.jiaoxueziliao )">点击下载</el-button>
					</div>
					<div class="btn_box">
			...
			<video v-if="detail.xuexishipin" ref="xuexishipin" :src="baseUrl +  detail.xuexishipin"  controls="controls" >
				您的浏览器不支持视频播放
			</video>
