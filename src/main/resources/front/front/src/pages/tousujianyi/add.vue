<template>
	<div class="add-update-preview">
		<el-form
			...
			<el-form-item class="add-item" label="投诉时间" prop="tousushijian">
				<el-date-picker
			...
			<el-form-item class="add-item" label="投诉内容" prop="tousuneirong">
				<editor 
			...
			async onSubmit() {
				await this.$refs["ruleForm"].validate(async valid => {
					if(valid) {
						...
						await this.$http.post(`tousujianyi/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(async res => {
							if (res.data.code == 0) {
								this.$message({
									message: '操作成功',
									type: 'success',
